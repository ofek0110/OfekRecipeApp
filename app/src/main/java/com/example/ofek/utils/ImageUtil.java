package com.example.ofek.utils;
...
// המחלקה הזו אחראית לבקש מהסמארטפון את ההרשאות המתאימות לפתיחת המצלמה והגלריה, ומספקת שתי פונקציות קריטיות: האחת דוחסת וממירה תמונה של מתכון לטקסט ארוך (Base64) לפני השמירה בענן, והשנייה לוקחת את הטקסט הזה מהענן והופכת אותו חזרה לתמונה מוחשית כשהמשתמש גולש באפליקציה.
